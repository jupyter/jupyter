...
.. graphviz::
	...
	digraph decide_project {
		...
		noinst [shape=plaintext; label="No installation\nneeded!"; fontcolor=blue]
		like [shape=plaintext; label="I like it,\nand I wish to install it!"; fontcolor=blue]
		my [shape=plaintext; label="On my system"; tooltip="Local Installation"; fontcolor=blue]
		// below kernel
		...
		try -> noinst -> online #[label="No installation needed"];
